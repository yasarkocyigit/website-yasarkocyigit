...
- [Part 1](/blog/azure-part-1-medallion-architecture): I established the foundation with Medallion Architecture, setting up Azure Data Lake Storage Gen2, implementing the bronze, silver, and gold layers, and creating the basic infrastructure for our data platform.
- [Part 2](/blog/azure-part-1-medallion-architecture): I integrated Unity Catalog for comprehensive data governance, implementing fine-grained access controls, data lineage tracking, and centralized metadata management across our data estate.
- [Part 3](/blog/azure-part-1-medallion-architecture): I dove deep into advanced Unity Catalog features, exploring managed and external tables, implementing data quality constraints, and setting up cross-workspace data sharing capabilities.
- [Part 4](/blog/azure-part-1-medallion-architecture): I demonstrated the migration from traditional mount points to Unity Catalog volumes, modernizing our data access patterns and improving security while maintaining backward compatibility.
